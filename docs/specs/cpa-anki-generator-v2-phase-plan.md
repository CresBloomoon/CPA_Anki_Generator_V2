...
（Claude Code が /home/node/.claude/plans/precious-splashing-quill.md に生成し、承認済みの計画のバックアップ。全27Phase。）
...
確認する）
- 依存：Phase6-1
- Done when：手動チェックリストが全項目パスする（この時点でPhase2-7〜2-9、5-5、5-6などの
任意Phaseに着手してよい）
...
---
（全27Phaseがタスクとして登録済み。任意Phase 2-7/2-8/2-9/5-5/5-6は除外、必要になった時点で追加）
